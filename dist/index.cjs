...
var images_default = {
  ...
  post: {
    ...
    "/get_history_by_ids": async (request2) => {
      request2.validate("body.history_ids", (v) => import_lodash13.default.isString(v) || import_lodash13.default.isArray(v)).validate("headers.authorization", import_lodash13.default.isString);
      const tokens = tokenSplit(request2.headers.authorization);
      const token = import_lodash13.default.sample(tokens);
      const { history_ids } = request2.body;
      const historyIds = import_lodash13.default.isString(history_ids) ? [history_ids] : history_ids;
